...
//! `schemas/manifest.v3.0.schema.json`. Rust types are generated by
...
//! (`ReleaseManifest`, `ReleaseEntry`) and provides a back-compat
...
pub use crate::core::wire::domain::{
    Group, Manifest as ReleaseManifest, ManifestParseError, Release as ReleaseEntry,
    ReleaseStatistics,
};
